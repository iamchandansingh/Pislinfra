...
return(<div className="cm-wrapper"><div className="cm-layout">
...
@media(min-width:1024px){.cm-layout{flex-direction:row;height:84vh;max-height:740px;min-height:650px;overflow:hidden;}}
...
@media(min-width:1024px){.cm-left-panel{width:45%;min-height:100%;align-items:flex-start;padding-top:65px;}}
