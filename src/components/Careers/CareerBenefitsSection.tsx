...
const benefitsData = [
  { id: 'salary', icon: <Wallet size={28} strokeWidth={2} />, iconColor: '#FF6B35', title: 'Competitive Salary', description: 'Industry-leading pay and performance incentives.' },
  { id: 'growth', icon: <TrendingUp size={28} strokeWidth={2} />, iconColor: '#FF6B35', title: 'Career Growth', description: 'Clear career path and opportunities for advancement.' },
  { id: 'learning', icon: <GraduationCap size={28} strokeWidth={2} />, iconColor: '#1E2A5A', title: 'Learning Programs', description: 'Continuous learning through training and certifications.' },
  { id: 'health', icon: <HeartPulse size={28} strokeWidth={2} />, iconColor: '#FF6B35', title: 'Health Benefits', description: 'Comprehensive health insurance for you and your family.' },
  { id: 'balance', icon: <Scale size={28} strokeWidth={2} />, iconColor: '#1E2A5A', title: 'Work-Life Balance', description: 'Flexible policies and support for personal well-being.' },
  { id: 'impact', icon: <Target size={28} strokeWidth={2} />, iconColor: '#FF6B35', title: 'Make an Impact', description: 'Work on meaningful projects that build a better India.' },
];
    ...
    <section style={{ width: '100%', backgroundColor: '#FFFFFF', padding: '48px 0', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ width: '95%', maxWidth: '1370px', margin: '0 auto', paddingLeft: '12px', paddingRight: '12px', boxSizing: 'border-box' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h2 style={{ fontSize: 'clamp(26px, 4vw, 36px)', fontWeight: 800, color: '#1E2A5A', margin: '0 0 10px 0', lineHeight: 1.2 }}>
          ...
          {benefitsData.map((benefit) => (
            <div key={benefit.id} style={{
              ...
              <div style={{ width: '52px', height: '52px', borderRadius: '50%', backgroundColor: '#FFFFFF', border: '1px solid #EEF2F7', boxShadow: '0 3px 10px rgba(15,23,42,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <span style={{ color: benefit.iconColor, display: 'flex', lineHeight: 0 }}>{benefit.icon}</span>
              </div>
