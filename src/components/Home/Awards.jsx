...
import clientsData from '../../data/clientsData'; // ← CENTRAL CLIENT DATA

// ==================== CLIENT LOGOS FROM CLIENTS DATA ====================
const getLogo = (name) => {
  const client = clientsData.find(c => c.name === name);
  return client?.logo || clientsData[0].logo; // fallback to first logo if not found
};
...
const awards = [
  ...
  { 
    ...
    logo: getLogo('Reliance Industries Limited'),           // ← Reliance logo
  ...
  { 
    id: 4, 
    company: 'Flipkart', 
    logo: getLogo('Flipkart'),                              // ← Flipkart logo
  ...
  { 
    id: 7, 
    company: 'Prologis',                                    // ← PRR Group → Prologis
  ...
  { 
    id: 10, 
    company: 'AM/NS India (ArcelorMittal Nippon Steel India)', // ← AMNS full name
  ...
  return (
    <section style={{ padding: '80px 24px', background: '#f4f6fa' }}>
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
            ...
            return (
              <motion.div 
                ...
                style={{ 
                  ...
                  boxShadow: isActive ? '0 20px 40px rgba(40,40,110,0.2)' : '0 4px 10px rgba(40,40,110,0.04)' 
                }}>
        ...
        {/* BOTTOM: More Achievements */}
        <div>
          <h3 style={{ fontSize: '18px', fontWeight: '800', color: NAVY, margin: '0 0 12px' }}>
            More <span style={{ color: ORANGE }}>Achievements</span>
          </h3>
