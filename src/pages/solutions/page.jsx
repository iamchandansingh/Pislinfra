...
const ServicesPage = () => {
  const seoData = {
    contentType: 'page',
    title: 'Our Solutions',
    seoTitle: 'Our Solutions | Pislinfra',
    seoDescription: 'Comprehensive industrial services - warehouse construction, logistic park development, infrastructure design & build. Expert solutions for industrial projects.',
    seoKeywords: 'industrial services, warehouse construction, logistics park, design build, industrial development, infrastructure services, Pislinfra',
    slug: 'solutions',
    canonicalUrl: 'https://pislinfra.com/solutions',
    ogTitle: 'Industrial Construction Solutions | Pislinfra',
    ogDescription: 'Expert industrial construction solutions - Design, Build & Logistics.',
    ogImage: 'https://pislinfra.com/images/hero/Service.png',
    ogType: 'website',
    twitterTitle: 'Industrial Construction Solutions | Pislinfra',
    twitterDescription: 'Warehouse, logistics & infrastructure development solutions.',
    twitterImage: 'https://pislinfra.com/images/hero/Service.png',
    twitterCardType: 'summary_large_image',
    schemaType: 'WebPage',
    breadcrumbSchema: true,
    organizationSchema: true,
    tags: ['Solutions', 'Design', 'Construction', 'Industrial', 'Infrastructure'],
  };
